...
public class Global {
	...
	/**
	 * 配置文件的路径(默认为当前目录下的 dragon.ini文件)
	 */
	private static String CONFIG_FILE = "dragon.ini";
	...
	/**
	 * 龙的初始长度, 对应的配置文件中的关键字为: init_length<BR>
	 * 范围2 至 最大宽度<BR>
	 * (单位:格) 缺省值为 2
	 */
